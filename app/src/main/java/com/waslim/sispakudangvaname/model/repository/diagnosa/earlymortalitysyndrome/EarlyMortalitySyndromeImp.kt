...
class EarlyMortalitySyndromeImp @Inject constructor(private val firebaseFirestore: FirebaseFirestore): EarlyMortalitySyndrome {
    override suspend fun getGejalaEarlyMortalitySyndrome(): Result<List<Penyakit>> {
        return suspendCoroutine { continuation ->
            firebaseFirestore.collection("early mortality syndrome")
                .get()
