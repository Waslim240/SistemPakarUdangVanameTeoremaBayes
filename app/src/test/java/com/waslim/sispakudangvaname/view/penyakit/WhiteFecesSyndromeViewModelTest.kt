...
class WhiteFecesSyndromeViewModelTest {

    private lateinit var whiteFecesSyndrome: WhiteFecesSyndrome
    private lateinit var whiteFecesSyndromeViewModel: WhiteFecesSyndromeViewModel
    ...
    @Before
    fun setup() {
        whiteFecesSyndrome = mock(WhiteFecesSyndrome::class.java)
        whiteFecesSyndromeViewModel = WhiteFecesSyndromeViewModel(whiteFecesSyndrome)
    }
    ...
    fun `ketika berhasil mengambil data`() = runTest {
        ...
        `when`(
            whiteFecesSyndrome.getGejalaWhiteFacesSyndrome()
        ).thenReturn(expectedData.value)

        whiteFecesSyndromeViewModel.getListGejalaWhiteFacesSyndrome()

        val actual = whiteFecesSyndromeViewModel.gejalaWhiteFacesSyndrome.getOrAwaitValue()

        verify(whiteFecesSyndrome).getGejalaWhiteFacesSyndrome()
